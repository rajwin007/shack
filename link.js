if(typeof(linkwithin_is_running)==='undefined'){linkwithin_is_running=true;LW={v:35,hs:[],ts:[],ps:[],ws:[],wsl:[],dh:0};LW.gsn=function(){var load=[0.20,0.00,0.35,0.10,0.35];var sum=function(n){var c=0;for(var i=0;i<n;c+=load[i++]);return c;}
